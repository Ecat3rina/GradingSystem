...
GO
PRINT N'Dropping Default Constraint unnamed constraint on [dbo].[Exams]...';


GO
ALTER TABLE [dbo].[Exams] DROP CONSTRAINT [DF__Exams__Id__38996AB5];


GO
PRINT N'Dropping Foreign Key [dbo].[FK_ExamSubjectId]...';


GO
ALTER TABLE [dbo].[Exams] DROP CONSTRAINT [FK_ExamSubjectId];
...
GO
PRINT N'Starting rebuilding table [dbo].[Exams]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Exams] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Exams])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Exams] ([Id], [StartDate], [EndDate], [NumberOfPages], [NumberOfEvaluators], [SubjectId], [EvaluationSchemeId])
        SELECT   [Id],
                 [StartDate],
                 [EndDate],
                 [NumberOfPages],
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Exams]', N'Exams';
