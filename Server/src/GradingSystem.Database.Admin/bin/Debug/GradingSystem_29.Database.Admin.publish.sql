...
GO
ALTER TABLE [dbo].[Exams] DROP CONSTRAINT [DF__Exams__Id__4222D4EF];
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Exams])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Exams] ([Id], [StartDate], [EndDate], [NumberOfPages], [NumberOfEvaluators], [SubjectId], [EvaluationSchemeId], [Name])
        SELECT   [Id],
                 [StartDate],
                 [EndDate],
                 [NumberOfPages],
