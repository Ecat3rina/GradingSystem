...
GO
PRINT N'The following operation was generated from a refactoring log file 0b677340-46ce-4b39-a723-4848a34e1323';

PRINT N'Rename [dbo].[Students].[Adress] to Address';


GO
EXECUTE sp_rename @objname = N'[dbo].[Students].[Adress]', @newname = N'Address', @objtype = N'COLUMN';
